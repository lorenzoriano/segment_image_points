...
public:
    PointCloudProjector() : nh_(), it_(nh_) {
        pc_sub_ = nh_.subscribe("/camera/depth_registered/points", 1, &PointCloudProjector::cloud_cb, this);
        camerasub_ = it_.subscribeCamera("/camera/rgb/image_rect_color", 1, &PointCloudProjector::image_cb, this);
